from streamlit import title, text_input, slider, selectbox, subheader, plotly_chart, image
...
subheader(f"{kind} for the next {forecast_days if forecast_days > 1 else ''} {'day' if forecast_days == 1 else 'days'} "
          f"in {place}")
